...
import type { Run, RunList, UpdateRun } from '../models/index';
import {
  RunFromJSON,
  RunToJSON,
  RunListFromJSON,
...
export interface RunApiInterface {
   ...
   */
  addRunRaw(
    requestParameters: AddRunRequest,
   ...
   */
  bulkUpdateRaw(
    requestParameters: BulkUpdateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RunList>>;
   ...
   */
  getRunListRaw(
    requestParameters: GetRunListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<RunList>>;
