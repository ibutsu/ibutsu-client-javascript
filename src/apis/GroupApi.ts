...
export interface GroupApiInterface {
     ...
     */
    addGroupRaw(requestParameters: AddGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Group>>;

    /**
     * Create a new group
     */
    addGroup(requestParameters: AddGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Group>;
     ...
     * @memberof GroupApiInterface
     */
    getGroupListRaw(requestParameters: GetGroupListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GroupList>>;

    /**
     * Get a list of groups
     */
    getGroupList(requestParameters: GetGroupListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GroupList>;
...
export class GroupApi extends runtime.BaseAPI implements GroupApiInterface {
     ...
     * Create a new group
     */
    async addGroupRaw(requestParameters: AddGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Group>> {
     ...
     * Create a new group
     */
    async addGroup(requestParameters: AddGroupRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Group> {
     ...
     * Get a list of groups
     */
    async getGroupListRaw(requestParameters: GetGroupListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GroupList>> {
        const queryParameters: any = {};
     ...
     * Get a list of groups
     */
    async getGroupList(requestParameters: GetGroupListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GroupList> {
