...
export function DashboardListFromJSONTyped(json: any, ignoreDiscriminator: boolean): DashboardList {
  ...
  return {
    dashboards:
      json['dashboards'] == null
        ? undefined
        : (json['dashboards'] as Array<any>).map(DashboardFromJSON),
...
export function DashboardListToJSONTyped(
  value?: DashboardList | null,
  ...
  return {
    dashboards:
      value['dashboards'] == null
        ? undefined
        : (value['dashboards'] as Array<any>).map(DashboardToJSON),
